...
export const rokaSignatureBrand: PartnerBrand = {
  ...
  note: "Browse the complete Signature catalogue below, then get in touch with us for pricing, samples and installation.",
};
...
export const rokaSignatureDoors: PartnerDoorModel[] = [
  {
    ...
    type: "Earth theme - warm, grounded earth tones (\"Tundra\")",
