...
const messages = {
  en: {
    ...
    exploreSystems: "Explore Systems", seeExampleDesigns: "See example designs", exampleDesigns: "Example Designs", comingSoon: "Coming soon", fullRangeComingSoon: "Full range coming soon",
    exploreColoursFinishes: "Explore colours & finishes", notSureSystem: "Not sure which system fits your project?", sendDimensions: "Send us your dimensions and we'll recommend the right door system.",
    techSheetNote: "Technical data sheet and full manufacturer PDF for every system.", partnerBannerTitle: "Like what you see from {brand}?", downloadCatalogueNamed: "Download {name} Catalogue (PDF)", systems: "Systems",
  },
  de: {
    ...
    exploreSystems: "Systeme entdecken", seeExampleDesigns: "Beispieldesigns ansehen", exampleDesigns: "Beispieldesigns", comingSoon: "Demnächst verfügbar", fullRangeComingSoon: "Komplettes Sortiment folgt in Kürze",
    exploreColoursFinishes: "Farben & Oberflächen entdecken", notSureSystem: "Nicht sicher, welches System zu Ihrem Projekt passt?", sendDimensions: "Senden Sie uns Ihre Maße – wir empfehlen Ihnen das passende Türsystem.",
    techSheetNote: "Technisches Datenblatt und vollständiges Hersteller-PDF zu jedem System.", partnerBannerTitle: "Gefällt Ihnen, was Sie von {brand} sehen?", downloadCatalogueNamed: "{name}-Katalog herunterladen (PDF)", systems: "Systeme",
  },
} as const;
...
/** Per-page copy that lives next to the page instead of in the global
 * dictionary. Usage: `const c = pick(await getLocale(), content);` */
export function pick<T>(locale: Locale, content: { en: T; de: T }): T {
